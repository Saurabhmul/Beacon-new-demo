...
const AIDerivedFieldSchema = z.object({
  ...
  data_type: z.enum(["boolean", "number", "string", "enum", "date"]).default("boolean"),
...
const AIBusinessFieldSchema = z.object({
  ...
  display_name: coerceToString,
  description: coerceToString,
  data_type: z.enum(["boolean", "number", "string", "enum", "date"]).default("string"),
  allowed_values: z.array(z.string()).default([]),
  default_value: coerceToString,
  business_meaning: coerceToString,
  creation_reason: coerceToString.optional().default(""),
...
DERIVED FIELD FORMAT
{
 ...
 "allowed_values": [] (use [] unless enum type),
 "default_value": null (use null when unclear),
 "business_meaning": "why this derived field exists",
